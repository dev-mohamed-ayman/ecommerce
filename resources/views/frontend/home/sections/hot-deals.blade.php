                ...
                <div class="col-xl-12">
                    <div class="wsus__section_header justify-content-start">
                        <div class="monthly_top_filter2 mb-1">
                            <button class="active auto_click" data-filter=".new_arrival">@lang('word.New Arrival')</button>
                            <button data-filter=".featured_product">@lang('word.Featured')</button>
                            <button data-filter=".top_product">@lang('word.Top Product')</button>
                            <button data-filter=".best_product">@lang('word.Best Product')</button>
