        ...
        <div class="row justify-content-between">
            <div class="col-xl-3 col-sm-7 col-md-6 col-lg-3">
                <div class="wsus__footer_content">
                    <a class="wsus__footer_2_logo" href="{{ url('/') }}">
                        <img src="{{ asset(@$footerInfo->logo) }}" alt="@lang('word.logo')">
                    </a>
                    <a class="action" href="tel:{{ @$footerInfo->phone }}"><i class="fas fa-phone-alt"></i>{{ @$footerInfo->phone }}</a>
            ...
            <div class="col-xl-4 col-sm-7 col-md-8 col-lg-5">
                <div class="wsus__footer_content wsus__footer_content_2">
                    <h3>@lang('word.Subscribe To Our Newsletter')</h3>
                    <p>@lang('word.Get all the latest information on Events, Sales and Offers. Get all the latest information on Events.')</p>
                    <form action="" method="POST" id="newsletter">
                        @csrf
                        <input type="text" placeholder="@lang('word.Email')" name="email" class="newsletter_email">
                        <button type="submit" class="common_btn subscribe_btn">@lang('word.subscribe')</button>
                    </form>
                    <div class="footer_payment">
                        <p>@lang('word.We\'re using safe payment for :')</p>
                        <img src="{{ asset('frontend/images/credit2.png') }}" alt="@lang('word.card')" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
