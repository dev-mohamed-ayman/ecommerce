                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <ul>
                            ...
                            <li><a href="javascript:;">@lang('word.payment')</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-3">
                        <div class="wsus__payment_menu" id="sticky_sidebar">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                aria-selected="true">@lang('word.Paypal')</button>
                                ...
                                <button class="nav-link common_btn" id="v-pills-profile-tab" data-bs-toggle="pill"
                                    ...
                                    aria-controls="v-pills-stripe" aria-selected="false">@lang('word.Stripe')</button>

                                <button class="nav-link common_btn" id="v-pills-profile-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-razorpay" type="button" role="tab"
                                aria-controls="v-pills-stripe" aria-selected="false">@lang('word.RazorPay')</button>

                                <button class="nav-link common_btn" id="v-pills-profile-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-cod" type="button" role="tab"
                                aria-controls="v-pills-stripe" aria-selected="false">@lang('word.COD')</button>
                                ...
                                <div class="row">
                                    <div class="col-xl-12 m-auto">
                                        <div class="wsus__payment_area">
                                            <a class="nav-link common_btn text-center" href="{{route('user.paypal.payment')}}">@lang('word.Pay with Paypal')</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="wsus__pay_booking_summary" id="sticky_sidebar2">
                            <h5>@lang('word.Order Summary')</h5>
                            <p>@lang('word.subtotal') : <span>{{$settings->currency_icon}}{{getCartTotal()}}</span></p>
                            <p>@lang('word.shipping fee(+)') : <span>{{$settings->currency_icon}}{{getShppingFee()}}</span></p>
                            <p>@lang('word.coupon(-)') : <span>{{$settings->currency_icon}}{{getCartDiscount()}}</span></p>
                            <h6>@lang('word.total') <span>{{$settings->currency_icon}}{{getFinalPayableAmount()}}</span></h6>
                        </div>
                    </div>
                </div>
            </div>
