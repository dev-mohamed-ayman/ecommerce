...
@section('title')
    {{$settings->site_name}} || @lang('word.Vendor Products')
@endsection
    ...
    <section id="wsus__breadcrumb">
        <div class="wsus_breadcrumb_overlay">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h4>@lang('word.vendor products')</h4>
                        <ul>
                            <li><a href="{{url('/')}}">@lang('word.home')</a></li>
                            <li><a href="javascript:;">@lang('word.vendor products')</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="wsus__pro_page_bammer vendor_det_banner">
                        ...
                        <div class="wsus__pro_page_bammer_text wsus__vendor_det_banner_text">
                            <div class="wsus__vendor_text_center">
                                ...
                                <a href="callto:{{$vendor->phone}}"><i class="far fa-phone-alt"></i> {{$vendor->phone}}
                                </a>
                                <a href="mailto:{{$vendor->email}}"><i class="far fa-envelope"></i> {{$vendor->email}}
                                </a>
                                <p class="wsus__vendor_location"><i
                                            class="fal fa-map-marker-alt"></i> {{$vendor->address}}</p>

                                <ul class="d-flex">
                                    <li><a class="facebook" href="{{$vendor->fb_link}}"><i
                                                    class="fab fa-facebook-f"></i></a></li>
                                    <li><a class="twitter" href="{{$vendor->tw_link}}"><i
                ...
                <div class="">
                            ...
                            <div class="wsus__product_topbar">
                                <div class="wsus__product_topbar_left">
                                    <div class="nav nav-pills" id="v-pills-tab" role="tablist"
                                        ...
                                        <button class="nav-link {{session()->has('product_list_style') && session()->get('product_list_style') == 'grid' ? 'active' : ''}} {{!session()->has('product_list_style') ? 'active' : ''}} list-view"
                                                data-id="grid" id="v-pills-home-tab" data-bs-toggle="pill"
                                                data-bs-target="#v-pills-home" type="button" role="tab"
                                                aria-controls="v-pills-home" aria-selected="true">
                                            <i class="fas fa-th"></i>
                                        </button>
                                        <button class="nav-link list-view {{session()->has('product_list_style') && session()->get('product_list_style') == 'list' ? 'active' : ''}}"
                                                ...
                                                <div class="wsus__product_details">
                                                    ...
                                                    <form class="shopping-cart-form">
                                                        ...
                                                        <button class="add_cart"
                                                                type="submit">@lang('word.add to cart')</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    @if (count($products) === 0)
                        <div class="text-center mt-5">
                            <div class="card">
                                <div class="card-body">
                                    <h2>@lang('word.Product not found!')</h2>
                                </div>
                            </div>
                        </div>
                    @endif
                                ...
                                <div class="col-xl-6 col-12 col-sm-12 col-md-12 col-lg-6">
                                    <div class="wsus__pro_details_text">
                                        ...
                                        <p class="wsus__stock_area"><span
                                                    class="in_stock">@lang('word.in stock')</span> @lang('word.(167 item)')
                                        </p>
                                        @if (checkDiscount($product))
                                            ...
                                            <ul class="wsus__button_area">
                                                <li>
                                                    <button type="submit" class="add_cart"
                                                            href="#">@lang('word.add to cart')</button>
                                                </li>
                                        ...
                                        <p class="brand_model">
                                            <span>@lang('word.brand') :</span> {{$product->brand->name}}</p>
