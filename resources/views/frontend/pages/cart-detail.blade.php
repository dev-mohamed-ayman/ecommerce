...
@section('title')
{{$settings->site_name}} || @lang('word.Cart Details')
@endsection
            ...
            <div class="row">
                                ...
                                <tbody>
                                    <tr class="d-flex">
                                        <th class="wsus__pro_img">
                                            @lang('word.product item')
                                        </th>

                                        <th class="wsus__pro_name">
                                            @lang('word.product details')
                                        </th>

                                        <th class="wsus__pro_tk">
                                           @lang('word.unit price')
                                        </th>
                                        ...
                                        <th class="wsus__pro_icon">
                                            <a href="#" class="common_btn clear_cart">@lang('word.clear cart')</a>
                                        </th>
                                    </tr>
                ...
                <div class="col-xl-3">
                    <div class="wsus__cart_list_footer_button" id="sticky_sidebar">
                        <h6>@lang('word.total cart')</h6>
                        <p>@lang('word.subtotal'): <span id="sub_total">{{$settings->currency_icon}}{{getCartTotal()}}</span></p>
                        <p>@lang('word.coupon(-)'): <span id="discount">{{$settings->currency_icon}}{{getCartDiscount()}}</span></p>
                        <p class="total"><span>@lang('word.total'):</span> <span id="cart_total">{{$settings->currency_icon}}{{getMainCartTotal()}}</span></p>

                        <form id="coupon_form">
                            <input type="text" placeholder="Coupon Code" name="coupon_code" value="{{session()->has('coupon') ? session()->get('coupon')['coupon_code'] : ''}}">
                            <button type="submit" class="common_btn">@lang('word.apply')</button>
                        </form>
                        <a class="common_btn mt-4 w-100 text-center" href="{{route('user.checkout')}}">checkout</a>
                        <a class="common_btn mt-1 w-100 text-center" href="{{route('home')}}"><i
                                class="fab fa-shopify"></i> @lang('word.Keep Shopping')</a>
                    </div>
                </div>
            </div>
        </div>
