    ...
    <section id="wsus__breadcrumb">
        <div class="wsus_breadcrumb_overlay">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h4>@lang('word.order tracking')</h4>
                        <ul>
                            <li><a href="#">@lang('word.home')</a></li>
                            <li><a href="#">@lang('word.order tracking')</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xl-5 col-md-10 col-lg-8 m-auto">
                        ...
                        <form class="tack_form" action="{{route('product-traking.index')}}" method="GET">
                            ...
                            <h4 class="text-center">@lang('word.order tracking')</h4>
                            <p class="text-center">@lang('word.tracking your order status')</p>
                            <div class="wsus__track_input">
                                <label class="d-block mb-2">@lang('word.invoice id*')</label>
                                <input type="text" placeholder="H25-21578455" name="tracker" value="{{@$order->invocie_id}}">
                            </div>
                            <button type="submit" class="common_btn">@lang('word.track')</button>
                        </form>
                    </div>
                </div>
                @if (isset($order))
                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-sm-6 col-lg-3">
                                        <div class="wsus__track_header_single">
                                            <h5>@lang('word.Order Date') </h5>
                                            <p>{{date('d M Y', strtotime(@$order->created_at))}}</p>
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-sm-6 col-lg-3">
                                        <div class="wsus__track_header_single">
                                            <h5>@lang('word.shopping by'):</h5>
                                            <p>{{@$order->user->name}}</p>
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-sm-6 col-lg-3">
                                        <div class="wsus__track_header_single">
                                            <h5>@lang('word.status'):</h5>
                                            <p>{{@$order->order_status}}</p>
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-sm-6 col-lg-3">
                                        <div class="wsus__track_header_single border_none">
                                            <h5>@lang('word.tracking'):</h5>
                    ...
                    <div class="col-xl-12">
                        <ul class="progtrckr" data-progtrckr-steps="4">
                            ...
                            <li class="progtrckr_done icon_one check_mark">@lang('word.Pending')</li>

                            @if (@$order->order_status == 'canceled')
                                <li class="icon_four red_mark">@lang('word.Order Canceled')</li>
                            @else
                    ...
                    <div class="col-xl-12">
                        <a href="{{url('/')}}" class="common_btn"><i class="fas fa-chevron-left"></i> @lang('word.back to home')</a>
                    </div>
                </div>
                @endif
            </div>
