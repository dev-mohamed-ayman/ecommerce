...
@section('title')
{{$settings->site_name}} || @lang('word.Product Details')
@endsection
    ...
    <section id="wsus__breadcrumb">
        <div class="wsus_breadcrumb_overlay">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h4>@lang('word.products details')</h4>
                        <ul>
                            <li><a href="#">@lang('word.home')</a></li>
                            <li><a href="#">@lang('word.peoduct')</a></li>
                            <li><a href="#">@lang('word.product details')</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                           ...
                           <p class="description">{!! $product->short_description !!}</p>
                            ...
                            <form class="shopping-cart-form">
                                ...
                                <ul class="wsus__button_area">
                                    <li><button type="submit" class="add_cart" href="#">@lang('word.add to cart')</button></li>
                            ...
                            <p class="brand_model"><span>@lang('word.brand') :</span> {{$product->brand->name}}</p>
                        </div>
                    </div>
                            ...
                            <ul class="nav nav-pills mb-3" id="pills-tab3" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="pills-home-tab7" data-bs-toggle="pill"
                                        ...
                                        aria-controls="pills-home" aria-selected="true">@lang('word.Description')</button>
                                </li>

                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                        data-bs-target="#pills-contact" type="button" role="tab"
                                        aria-controls="pills-contact" aria-selected="false">@lang('word.Vendor Info')</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-contact-tab2" data-bs-toggle="pill"
                                        data-bs-target="#pills-contact2" type="button" role="tab"
                                        aria-controls="pills-contact2" aria-selected="false">@lang('word.Reviews')</button>
                                </li>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6 col-xxl-5 col-md-6">
                                                <div class="wsus__vebdor_img">
                                                    <img src="{{asset($product->vendor->banner)}}" alt="@lang('word.vensor')" class="img-fluid w-100">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-xxl-7 col-md-6 mt-4 mt-md-0">
                                                <div class="wsus__pro_det_vendor_text">
                                                    ...
                                                    <p class="rating">
                                                        ...
                                                        <span>({{count($product->reviews)}} @lang('word.review')</span>
                                                    </p>
                                                    ...
                                                    <a href="vendor_details.html" class="see_btn">@lang('word.visit store')</a>
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-8 col-lg-7">
                                                    <div class="wsus__comment_area">
                                                        <h4>@lang('word.Reviews') <span>{{count($reviews)}}</span></h4>
                                                ...
                                                <div class="col-xl-4 col-lg-5 mt-4 mt-lg-0">
                                                    ...
                                                    <div class="wsus__post_comment rev_mar" id="sticky_sidebar3">
                                                        ...
                                                        <form action="{{route('user.review.create')}}" enctype="multipart/form-data" method="POST">
                                                            @csrf
                                                            <p class="rating">
                                                                <span>@lang('word.select your rating') : </span>
                                                            </p>
                                                                ...
                                                                <div class="col-xl-12 mb-4">
                                                                    <div class="wsus__single_com">
                                                                        <select name="rating" id="" class="form-control">
                                                                            <option value="">@lang('word.Select')</option>
                                                                    ...
                                                                    <div class="col-xl-12">
                                                                        <div class="wsus__single_com">
                                                                            <textarea cols="3" rows="3" name="review"
                                                                                placeholder="@lang('word.Write your review')"></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <button class="common_btn" type="submit">@lang('word.submit
                                                                review')</button>
                                                        </form>
                                                    </div>
                                                    @endif
