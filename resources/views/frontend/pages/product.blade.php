                                    ...
                                    <div class="accordion-body">
                                        <div class="price_ranger">
                                            <form action="{{url()->current()}}">
                                                ...
                                                <button type="submit" class="common_btn">@lang('word.filter')</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="wsus__product_item">
                                            ...
                                            <div class="wsus__product_details">
                                                ...
                                                <p class="wsus__pro_rating">
                                                    ...
                                                    <span>({{$product->reviews_count}} @lang('word.review')</span>
                                                </p>
                                                ...
                                                <form class="shopping-cart-form">
                                                    ...
                                                    <button class="add_cart" type="submit">@lang('word.add to cart')</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="wsus__product_details">
                                                ...
                                                <ul class="wsus__single_pro_icon">
                                                    ...
                                                    <form class="shopping-cart-form">
                                                        ...
                                                        @endforeach
                                                        <input class="" name="qty" type="hidden" min="1" max="100" value="1" />
                                                        <button class="add_cart_two mr-2" type="submit">@lang('word.add to cart')</button>
                                                    </form>
